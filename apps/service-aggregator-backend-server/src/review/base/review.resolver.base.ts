...
import { ServiceListing } from "../../serviceListing/base/ServiceListing";
...
export class ReviewResolverBase {
  ...
  async createReview(@graphql.Args() args: CreateReviewArgs): Promise<Review> {
    return await this.service.createReview({
      ...
      data: {
        ...
        serviceListing: args.data.serviceListing
          ? {
              connect: args.data.serviceListing,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => ServiceListing, {
    nullable: true,
    name: "serviceListing",
  })
  async getServiceListing(
    @graphql.Parent() parent: Review
  ): Promise<ServiceListing | null> {
    const result = await this.service.getServiceListing(parent.id);
